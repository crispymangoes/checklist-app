...
<div class="flex items-center justify-between rounded-md border-2 border-gray-one px-5 py-4 ">
    <div class="flex w-full max-w-lg items-center justify-start">
        ...
        class="h-4 w-4 rounded border border-gray-three bg-cream-four
         text-green-four focus:border-green-five focus:outline 
         focus:outline-2 foucs:outline-offset-2 focus:outline-green-five"
        />
        ...
        class="ml-5 flex-1 text-ellipsis rounded-none border-x-0 border-t-0
        border-b border-dashed border-b-gray-two bg-cream-four px-0 pb-1
        text-base font-nromal text-gray-three placeholder:text-gray-two
    ...
    <button type="button" on:click={() => deleteTodo(todo.id)} class="group 
        ml-4 flex items-center justify-center rounded-md
